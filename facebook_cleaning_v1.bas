Attribute VB_Name = "facebook_cleaning"
...
ActiveSheet.Range("a1").AutoFilter field:=11, Criteria1:="Facebook Messenger"

Call identifyRecipient

Call fbSplitFromColumn
