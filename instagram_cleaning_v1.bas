Attribute VB_Name = "Instagram_cleaning"
...
ActiveSheet.Range("a1").AutoFilter field:=11, Criteria1:="Instagram"

Call identifyRecipient

Call igSplitFromColumn
