Attribute VB_Name = "kick_cleaning"

Sub kickMessengerMain()

'removes all filters on activesheet
Call clearFilter

'applies a filter to Source (k) equal to Facebook Messenger
ActiveSheet.Range("a1").AutoFilter field:=11, Criteria1:="Kik Messenger"
...
Call kmSplitToColumn

Call kmSplitFromColumn
