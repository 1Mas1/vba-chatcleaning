Attribute VB_Name = "tiktok_cleaning"
...
ActiveSheet.Range("a1").AutoFilter field:=11, Criteria1:="TikTok"

Call identifyRecipient

Call ttSplitFromColumn
